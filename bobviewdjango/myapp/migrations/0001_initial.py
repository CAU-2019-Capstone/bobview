    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_image', models.ImageField(blank=True, upload_to='')),
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.RestaurantInfo')),
            ],
            options={
                'db_table': 'qr_images',
        ...
        migrations.CreateModel(
            name='CommentList',
            fields=[
                ('comment_list_id', models.AutoField(primary_key=True, serialize=False)),
                ('comment', models.TextField()),
                ('menu_rating', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.MenuRating')),
                ('rest_rating', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.RestRating')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
