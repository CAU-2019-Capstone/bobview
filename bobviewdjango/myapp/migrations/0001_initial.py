    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_rating', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.MenuRating')),
                ('rest_rating', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.RestRating')),
            ],
            options={
