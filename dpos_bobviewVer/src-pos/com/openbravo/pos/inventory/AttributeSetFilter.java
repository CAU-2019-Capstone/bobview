...
public class AttributeSetFilter extends javax.swing.JPanel implements ReportEditorCreator {
    private static final long serialVersionUID = 6872113446185536714L;
    ...
    public void init(AppView app) {
        ...
        attusesent = new StaticSentence(app.getSession(), "SELECT ID, NAME FROM ATTRIBUTESET ORDER BY NAME", null, new SerializerRead() {
            @Override
    ...
    private void initComponents() {
        ...
        jAttrSet.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
