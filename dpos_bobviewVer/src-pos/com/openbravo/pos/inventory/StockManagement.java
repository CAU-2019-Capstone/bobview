...
public class StockManagement extends JPanel implements JPanelView {
    private static final long serialVersionUID = -2289026714167064073L;
...
// JG 16 May 2013 use multicatch
    ...
    private void initComponents() {
        ...
        catcontainer.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jLocationDes.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        m_jDown.setToolTipText("아래로 스크롤");
        ...
        jEditAttributes.setToolTipText("속성");
        ...
        jPanel8.add(jEditAttributes, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 160, 50, 40));

        btnDownloadProducts.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jNumberKeys.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
