...
public class TaxEditor extends JPanel implements EditorRecord {
    private static final long serialVersionUID = -3922586520526122204L;
    ...
    private void initComponents() {
        ...
        m_jRate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jRate);
        m_jRate.setBounds(240, 140, 60, 25);

        jLabel1.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabel1.setText(AppLocal.getIntString("Menu.TaxCategories")); // NOI18N
        add(jLabel1);
        ...
        jCascade.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jCascade.setText(AppLocal.getIntString("label.cascade")); // NOI18N
        add(jCascade);
        jCascade.setBounds(320, 140, 110, 25);

        m_jTaxCategory.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        add(m_jTaxCategory);
        m_jTaxCategory.setBounds(240, 50, 200, 25);

        m_jTaxParent.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        add(m_jTaxParent);
        m_jTaxParent.setBounds(240, 110, 200, 25);

        m_jCustTaxCategory.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jOrder.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(jOrder);
