...
public class AttributeValuesPanel extends JPanelTable2 {
    private static final long serialVersionUID = 7185558129324787448L;
    ...
    protected void init() {
        ...
        row = new Row(
                ...
                new Field(AppLocal.getIntString("label.value3"), Datas.STRING, Formats.STRING, true, true, true)
        );
