...
public final class StockDiaryEditor extends javax.swing.JPanel implements EditorRecord {
    private static final long serialVersionUID = -7919415216444797111L;
...
//    }
    ...
    private void initComponents() {
        ...
        m_jdate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jbtndate.setToolTipText("달력 열기");
        ...
        m_jbtndate.setBounds(310, 3, 40, 36);
        ...
        m_jreason.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jproduct.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jEditProduct.setToolTipText("상품 리스트 검색");
        ...
        jEditProduct.setBounds(310, 38, 40, 36);
        ...
        m_jLocation.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        jPanel1.add(m_jLocation);
        m_jLocation.setBounds(440, 45, 200, 25);

        jLabel7.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabel7.setText(AppLocal.getIntString("label.bybarcode")); // NOI18N
        ...
        m_jcodebar.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jEnter.setToolTipText("바코드 읽기");
        ...
        m_jreference.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jEnter1.setToolTipText("상품 ID 입력");
        ...
        jattributes.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jEditAttributes.setToolTipText("상품 속성");
        ...
        m_junits.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
