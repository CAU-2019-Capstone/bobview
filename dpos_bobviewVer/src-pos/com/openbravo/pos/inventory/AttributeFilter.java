...
public class AttributeFilter extends javax.swing.JPanel implements ReportEditorCreator {
    private static final long serialVersionUID = 683528006752386360L;
    ...
    public void init(AppView app) {
        ...
        attsent = new StaticSentence(app.getSession(), "SELECT ID, NAME FROM ATTRIBUTE ORDER BY NAME", null, new SerializerRead() {
            @Override
    ...
    private void initComponents() {
        ...
        jAttr.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
