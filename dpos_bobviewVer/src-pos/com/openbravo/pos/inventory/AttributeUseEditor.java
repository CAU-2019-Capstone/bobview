...
public class AttributeUseEditor extends javax.swing.JPanel implements EditorRecord {
    private static final long serialVersionUID = 6607512638613388266L;
    ...
    private void initComponents() {
        ...
        jLineno.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        jLabel4.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabel4.setText(AppLocal.getIntString("label.attribute")); // NOI18N

        jAttribute.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
