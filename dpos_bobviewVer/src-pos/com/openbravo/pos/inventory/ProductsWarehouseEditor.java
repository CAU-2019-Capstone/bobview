...
public class ProductsWarehouseEditor extends javax.swing.JPanel implements EditorRecord {
    private static final long serialVersionUID = -4923880772317394986L;
    ...
    private void initComponents() {
        ...
        m_jTitle.setFont(StartPOS.getgblFont().deriveFont( 3, 18)); // NOI18N
        add(m_jTitle);
        ...
        m_jQuantity.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jMinimum.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jMaximum.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
