...
public class AuxiliarEditor extends javax.swing.JPanel implements EditorRecord {
    private static final long serialVersionUID = 2680455395496356561L;
    ...
    private void initComponents() {
        ...
        add(m_jEnter1);
        m_jEnter1.setBounds(250, 11, 52, 36);
        ...
        add(m_jEnter2);
        m_jEnter2.setBounds(557, 11, 50, 34);
        ...
        add(m_jSearch);
        m_jSearch.setBounds(10, 50, 52, 36);
        ...
        m_jBarcode.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabel4.setText(AppLocal.getIntString("label.bybarcode")); // NOI18N
