...
public final class CategoriesEditor extends JPanel implements EditorRecord {
    private static final long serialVersionUID = -9209402601759423369L;
...
// Added JDL 13.04.13
    ...
    private void initComponents() {
        ...
        m_jCatalogAdd.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        add(m_jCatalogAdd);
        m_jCatalogAdd.setBounds(160, 400, 80, 30);

        m_jCatalogDelete.setFont(StartPOS.getgblFont().deriveFont( 0, 10)); // NOI18N
        ...
        m_jCatalogDelete.setBounds(160, 440, 80, 30);

        jLabel5.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabel5.setText(AppLocal.getIntString("label.item")); // NOI18N
        add(jLabel5);
        ...
        add(jLabel7);
        jLabel7.setBounds(20, 130, 130, 17);

        m_jCatNameShow.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jCatNameShow.setSelected(true);
        add(m_jCatNameShow);
        m_jCatNameShow.setBounds(195, 130, 30, 18);
        ...
        add(jLabel8);
        jLabel8.setBounds(10, 410, 110, 40);
