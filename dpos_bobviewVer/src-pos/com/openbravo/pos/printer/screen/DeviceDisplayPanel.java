...
public class DeviceDisplayPanel extends JPanel implements DeviceDisplay, DeviceDisplayImpl {
    private static final long serialVersionUID = 2239245114332500770L;
    ...
    public DeviceDisplayPanel(double dZoom) {
        ...
        jline1.setFont(StartPOS.getgblFont().deriveFont(Font.BOLD, (int)(16 * dZoom)));
        jline2.setFont(StartPOS.getgblFont().deriveFont(Font.BOLD, (int)(16 * dZoom)));
    ...
    private void initComponents() {
        ...
        jline1.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jline2.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
