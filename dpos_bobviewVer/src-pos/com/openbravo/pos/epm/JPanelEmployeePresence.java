...
public class JPanelEmployeePresence extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    private static final long serialVersionUID = 1704514800474506346L;
    ...
    private class BreakAction extends AbstractAction {
        private static final long serialVersionUID = -6970573398963568522L;
    ...
    private void initComponents() {
        ...
        btnCheckIn.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        btnCheckIn.setText("체크 인");
        ...
        btnCheckOut.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        btnCheckOut.setText("체크 아웃");
        ...
        message.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
