...
public final class BreaksView extends javax.swing.JPanel implements EditorRecord {
    private static final long serialVersionUID = -2742389326134589677L;
    ...
    private void initComponents() {
        ...
        m_jBreakName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        m_jBreakDescription.setColumns(20);
        m_jBreakDescription.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_Ncx.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_Ncx.setText(AppLocal.getIntString("label.epm.visible")); // NOI18N

        m_Name3.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
