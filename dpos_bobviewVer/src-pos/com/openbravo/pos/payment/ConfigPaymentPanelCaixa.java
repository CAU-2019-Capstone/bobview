...
public class ConfigPaymentPanelCaixa extends javax.swing.JPanel implements PaymentConfiguration {
    private static final long serialVersionUID = -3203895041745299402L;
    ...
    private void initComponents() {
        ...
        jtxtCommerceCode.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jtxtCommerceCode.setPreferredSize(new java.awt.Dimension(200, 30));

        jtxtCommerceSign.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jtxtCommerceTerminal.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
