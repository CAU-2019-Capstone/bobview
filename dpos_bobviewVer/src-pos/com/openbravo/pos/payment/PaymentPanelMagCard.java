...
public class PaymentPanelMagCard extends javax.swing.JPanel implements PaymentPanel {
    private static final long serialVersionUID = -5960214372712230657L;
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(StartPOS.getgblFont().deriveFont( 1, 18)); // NOI18N
        ...
        jReset.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        m_jExpirationDate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jCardNumber.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jHolderName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
