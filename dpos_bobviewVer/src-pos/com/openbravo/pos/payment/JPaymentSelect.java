...
// * Bank Payment receipt - Thanks Steve Clough! August 2011
    ...
    private void initComponents() {
        ...
        m_jTotalEuros.setFont(StartPOS.getgblFont().deriveFont( 1, 16)); // NOI18N
        ...
        m_jLblRemainingEuros.setFont(StartPOS.getgblFont().deriveFont( 1, 14)); // NOI18N
        m_jLblRemainingEuros.setText(AppLocal.getIntString("label.remainingcash")); // NOI18N
        jPanel6.add(m_jLblRemainingEuros);

        m_jRemaininglEuros.setFont(StartPOS.getgblFont().deriveFont( 1, 16)); // NOI18N
        ...
        m_jButtonOK.setFont(StartPOS.getgblFont().deriveFont( 1, 12)); // NOI18N
