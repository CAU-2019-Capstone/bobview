...
public class ConfigPaymentPanelLinkPoint extends javax.swing.JPanel implements PaymentConfiguration {
    private static final long serialVersionUID = -9153367874006942423L;
    ...
    private void initComponents() {
        ...
        jtxtStoreName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jtxtStoreName.setPreferredSize(new java.awt.Dimension(200, 30));

        jtxtCertificatePass.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jtxtCertificatePass.setPreferredSize(new java.awt.Dimension(200, 30));

        jtxtCertificatePath.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
