...
public class JPaymentDebt extends javax.swing.JPanel implements JPaymentInterface {
    private static final long serialVersionUID = -430204708997508053L;
    ...
    private void initComponents() {
        ...
        m_jMoneyEuros.setFont(StartPOS.getgblFont().deriveFont( 1, 18)); // NOI18N
        ...
        jlblMessage.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jTendered.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
