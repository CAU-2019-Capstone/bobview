...
public class JProductLineEdit extends javax.swing.JDialog {
    private static final long serialVersionUID = 6617203146325697056L;
...
//        m_jName.setText(m_oLine.getProperty("product.name"));
    ...
    private void initComponents() {
        ...
        m_jPriceTax.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jTaxrate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jTotal.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jSubtotal.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jButtonCancel.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jButtonOK.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
