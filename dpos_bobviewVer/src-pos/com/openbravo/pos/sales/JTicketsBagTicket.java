...
public class JTicketsBagTicket extends JTicketsBag {
    private static final long serialVersionUID = 2416275846207225050L;
        ...
        try {
            ...
            if (ticket == null) {
                ...
                try {
                    ...
                    System.out.println("readTicket 에러1");
    ...
    private void initComponents() {
        ...
        m_jTicketId.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jButton2.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        jButton2.setToolTipText("영수증 검색");
        ...
        m_jEdit.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        m_jEdit.setToolTipText("현재 영수증 수정");
        ...
        m_jRefund.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        m_jRefund.setToolTipText("영수증 환불");
        ...
        m_jPrint.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        m_jPrint.setToolTipText("영수증 재출력");
        ...
        m_jPanelTicket.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jTicketEditor.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jrbSales.setFont(StartPOS.getgblFont().deriveFont( 1, 14)); // NOI18N
        ...
        jrbRefunds.setFont(StartPOS.getgblFont().deriveFont( 1, 14)); // NOI18N
