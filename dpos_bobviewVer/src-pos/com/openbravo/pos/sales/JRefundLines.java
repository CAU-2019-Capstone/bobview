...
public class JRefundLines extends javax.swing.JPanel {
    private static final long serialVersionUID = -7062271774846888799L;
...
public JRefundLines(DataLogicSystem dlSystem, JPanelTicketEdits jTicketEdit) {
    ...
    private void initComponents() {
        ...
        m_jbtnAddOne.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jbtnAddLine.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jbtnAddAll.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
