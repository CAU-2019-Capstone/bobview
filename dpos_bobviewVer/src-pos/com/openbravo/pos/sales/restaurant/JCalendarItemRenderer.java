...
public class JCalendarItemRenderer extends javax.swing.JPanel implements ListCellRenderer, Serializable {
    private static final long serialVersionUID = 3589296884502493414L;
    ...
    public JCalendarItemRenderer() {
        ...
        m_jTime.setFont(StartPOS.getgblFont().deriveFont(1, 11)); // HORA
        m_jTitle.setFont(StartPOS.getgblFont().deriveFont(1, 11)); // TITULO
        m_jDescription.setFont(StartPOS.getgblFont().deriveFont(2, 11)); // TEXTO EXPLICATIVO
    ...
    */
    ...
    private void initComponents() {
        ...
        m_jDescription.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jTime.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jTime.setForeground(new java.awt.Color(0, 0, 255));
        m_jTime.setText("10:20");
        jPanel1.add(m_jTime, java.awt.BorderLayout.WEST);

        m_jTitle.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
