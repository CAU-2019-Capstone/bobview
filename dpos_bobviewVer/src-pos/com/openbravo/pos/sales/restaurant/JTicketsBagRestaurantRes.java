...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    private static final long serialVersionUID = -4101713396371139265L;
    ...
    private void initComponents() {
        ...
        m_jbtnTables.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jbtnReceive.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jtxtDescription.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jtxtChairs.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        txtCustomer.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
