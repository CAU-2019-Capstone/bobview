...
public class JTicketsBagShared extends JTicketsBag {
    private static final long serialVersionUID = 7154336985530565410L;
...
//                    }else{
    ...
    private void initComponents() {
        ...
        m_jNewTicket.setToolTipText("판매보류/새 판매");
        ...
        m_jDelTicket.setToolTipText("판매 취소");
        ...
        m_jListTickets.setToolTipText("보류목록");
