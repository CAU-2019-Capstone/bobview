...
// JG June 2013 use diamond inference
    ...
    public void calculateTaxes(TicketInfo ticket) throws TaxesException {
        ...
        System.out.println("calculateTaxes 에러");
       
        for (TicketLineInfo line: ticket.getLines()) {
              System.out.println("calculateTaxes 에러1");
            tickettaxes = sumLineTaxes(tickettaxes, calculateTaxes(line));
          System.out.println("calculateTaxes 에러111");
        }     // tax 에러
        System.out.println("calculateTaxes 에러2");
    ...
    private List<TicketTaxInfo> sumLineTaxes(List<TicketTaxInfo> list1, List<TicketTaxInfo> list2) {
        ...
        for (TicketTaxInfo tickettax : list2) {
            ...
            System.out.println("sumLineTaxes 에러1");
               System.out.println(i.getTotal());
               System.out.println("sumLineTaxes 에러2");
            if (i == null) {
                list1.add(tickettax);
                System.out.println("sumLineTaxes 에러3");
            } else {
                i.add(tickettax.getSubTotal());
                System.out.println("sumLineTaxes 에러4");
            }
    ...
    private TicketTaxInfo searchTicketTax(List<TicketTaxInfo> l, String id) {
        ...
        for (TicketTaxInfo tickettax : l) {
            System.out.println(tickettax.getTaxInfo().getId());
            System.out.println("searchTickettax");
