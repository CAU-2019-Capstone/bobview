...
public class SimpleReceipt extends javax.swing.JPanel {
    private static final long serialVersionUID = -8003138997135022522L;
    ...
    private void initComponents() {
        ...
        m_jTotalEuros.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jLblTotalEuros1.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jSubtotalEuros.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jTaxesEuros.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jLblTotalEuros2.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jLblTotalEuros3.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        btnCustomer.setToolTipText("고객정보 보기");
