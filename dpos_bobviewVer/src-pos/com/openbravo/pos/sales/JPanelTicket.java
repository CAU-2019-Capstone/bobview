...
//      JG 19 Feb 14 unnecessary parse - if (Boolean.valueOf(m_App.getProperties().getProperty("till.amountattop")).booleanValue()){
    ...
    private class logout extends AbstractAction {
        private static final long serialVersionUID = 8423908663638358139L;
...
//      if ("restaurant".equals(m_App.getProperties().getProperty("machine.ticketsbag"))&& m_oTicket.getTicketType()!=1){
            if ("테이블 후불 모드".equals(m_App.getProperties().getProperty("machine.ticketsbag")) && !oTicket.getOldTicket()) {
...
// check if the old table and the new table are the same                      
        ...
        if ("테이블 후불 모드".equals(m_App.getProperties().getProperty("machine.ticketsbag"))) {
...
//added by JDL Autologoff after sales            
    ...
    private boolean closeTicket(TicketInfo ticket, Object ticketext) {      // (bobview) 결제 진행
        if (listener != null) {
            listener.stop();
        }
...
// Check if we have a warranty to print                         
            ...
            System.out.println("영수증 디버깅0");
     
            try {
                // reset the payment info
                System.out.println("영수증 디버깅1");
            
                taxeslogic.calculateTaxes(ticket);      // 문제
                System.out.println("영수증 디버깅2");
            
                if (ticket.getTotal() >= 0.0) {
                    ticket.resetPayments(); //Only reset if is sale
                    System.out.println("영수증 디버깅3");
                ...
                if (executeEvent(ticket, ticketext, "ticket.total") == null) {
                    if (listener != null) {
                        listener.stop();
                        System.out.println("영수증 디버깅4");
         
                    }
                    // Muestro el total
                    // 결제 확인 버튼 이벤트
                    printTicket("Printer.TicketTotal", ticket, ticketext);
System.out.println("영수증 디버깅5");
...
//                            if ("restaurant".equals(m_App.getProperties().getProperty("machine.ticketsbag"))&&  m_oTicket.getTicketType() !=1) {  
                            if ("테이블 후불 모드".equals(m_App.getProperties().getProperty("machine.ticketsbag")) && !ticket.getOldTicket()) {
...
// End mod
    ...
    private void initComponents() {
        ...
        jButton1.setToolTipText("신규 고객 추가");
        ...
        btnCustomer.setToolTipText("고객 정보 보기");
        ...
        m_jbtnScale.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        j_btnKitchenPrt.setToolTipText("오더 전송");
        ...
        jPanel5.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jUp.setToolTipText("라인 위로 스크롤");
        ...
        m_jDown.setToolTipText("라인 아래로 스크롤");
        ...
        m_jDelete.setToolTipText("라인 삭제");
        ...
        m_jEditLine.setToolTipText("라인 수정");
        ...
        jEditAttributes.setToolTipText("속성 선택");
        ...
        m_jPanelCentral.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        m_jPanelCentral.setPreferredSize(new java.awt.Dimension(450, 240));
        m_jPanelCentral.setLayout(new java.awt.BorderLayout());

        jPanel4.setLayout(new java.awt.BorderLayout());

        m_jTicketId.setFont(StartPOS.getgblFont().deriveFont( 1, 12)); // NOI18N
        ...
        m_jLblTotalEuros3.setFont(StartPOS.getgblFont().deriveFont( 1, 14)); // NOI18N
        ...
        m_jLblTotalEuros2.setFont(StartPOS.getgblFont().deriveFont( 1, 14)); // NOI18N
        ...
        m_jLblTotalEuros1.setFont(StartPOS.getgblFont().deriveFont( 1, 14)); // NOI18N
        ...
        m_jSubtotalEuros.setFont(StartPOS.getgblFont().deriveFont( 0, 18)); // NOI18N
        ...
        m_jTaxesEuros.setFont(StartPOS.getgblFont().deriveFont( 0, 18)); // NOI18N
        ...
        m_jTotalEuros.setFont(StartPOS.getgblFont().deriveFont( 1, 18)); // NOI18N
        ...
        m_jContEntries.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jPrice.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jPor.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jEnter.setToolTipText("바코드 입력");
        ...
        m_jaddtax.setFont(StartPOS.getgblFont().deriveFont( 1, 11)); // NOI18N
        m_jaddtax.setText("+");
