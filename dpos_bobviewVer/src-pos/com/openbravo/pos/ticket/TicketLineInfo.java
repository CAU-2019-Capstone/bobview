...
public class TicketLineInfo implements SerializableWrite, SerializableRead, Serializable {
     ...
     * @param barcode
     */
    public TicketLineInfo(String productid, String productname, String producttaxcategory, double dMultiply, double dPrice, TaxInfo tax, String barcode) {
        Properties props = new Properties();
        props.setProperty("product.name", productname);
        props.setProperty("product.taxcategoryid", producttaxcategory);
        props.setProperty("product.barcode", barcode);
        init(productid, null, dMultiply, dPrice, tax, barcode, props);
    }
...
//        
    ...
    public TicketLineInfo(TicketLineInfo line) {
        init(line.productid, line.attsetinstid, line.multiply, line.price, line.tax, line.barcode, (Properties) line.attributes.clone());
    }

    public TicketLineInfo(String menu_name, String menu_id, String menu_num, String menu_price, TaxInfo tax) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public TicketLineInfo(String menu_name, String menu_num, String menu_price, TaxInfo tax) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private void init(String productid, String attsetinstid, double dMultiply, double dPrice, TaxInfo tax, String barcode, Properties attributes) {
    ...
    public String printBarcode() {
        return StringUtils.encodeXML(attributes.getProperty("product.barcode"));
    }
