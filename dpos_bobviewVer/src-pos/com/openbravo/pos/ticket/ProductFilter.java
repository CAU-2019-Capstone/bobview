...
public class ProductFilter extends javax.swing.JPanel implements ReportEditorCreator {
    private static final long serialVersionUID = 7930400128801121941L;
...
//        m_jCboPriceSell.setModel(new ListQBFModelNumber());
    ...
    private void initComponents() {
        ...
        jLabel5.setText(AppLocal.getIntString("label.bybarcode")); // NOI18N
        ...
        jLabel1.setText(AppLocal.getIntString("label.item")); // NOI18N
        ...
        jLabel4.setText(AppLocal.getIntString("label.prodvaluebuy")); // NOI18N

        m_jCboName.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N

        m_jName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        m_jPriceBuy.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        m_jCboPriceBuy.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N

        m_jCboPriceSell.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
