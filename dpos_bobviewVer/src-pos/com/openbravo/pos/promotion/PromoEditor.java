...
public class PromoEditor extends JPanel implements EditorRecord {
    private static final long serialVersionUID = 5186383298396456322L;
...
//                jLabel13.setText("%");
    ...
    private void initComponents() {
        ...
        m_jArticle.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jArticle.setPreferredSize(new java.awt.Dimension(110, 28));

        m_jBonusArticle.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jBonusArticle.setPreferredSize(new java.awt.Dimension(110, 28));

        m_jCategory.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabel1.setText("<html><b>프로모션 이름</b>");
        ...
        m_jStartDate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        m_jStartHour.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jStartHour.setPreferredSize(new java.awt.Dimension(110, 28));

        m_jType.setPreferredSize(new java.awt.Dimension(210, 25));

        m_jProdName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jAmount.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jAmount.setPreferredSize(new java.awt.Dimension(110, 28));

        m_jMin.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jMin.setPreferredSize(new java.awt.Dimension(68, 28));

        m_jStepAmount.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jStepAmount.setPreferredSize(new java.awt.Dimension(110, 28));

        m_jStepQty.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        m_jStepQty.setPreferredSize(new java.awt.Dimension(110, 28));

        m_jBonusProd.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jEndDate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jEndHour.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jMax.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
