...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
    private static final long serialVersionUID = 6567702768759098425L;
...
//        public JTaskPaneGroup getTaskGroup() {
    ...
    private class ExitAction extends AbstractAction {
        private static final long serialVersionUID = -8743336784412893439L;
    ...
    private class ChangePasswordAction extends AbstractAction {
        private static final long serialVersionUID = 5371493437238626060L;
    ...
    public void showTask(String sTaskClass) {
        ...
        if (m_appuser.hasPermission(sTaskClass)) {
            ...
            if (stacktop < MAX_STACK) {
                m_taskstack[stacktop++] = sTaskClass;
            } else {
                for (int i = 0; i < (MAX_STACK - 1); i++) {
                    m_taskstack[i] = m_taskstack[i + 1];
                }
                m_taskstack[MAX_STACK - 1] = sTaskClass;
            }
...
// JG Added 10 Nov 12
    ...
    private void initComponents() {
        ...
        jButton1.setToolTipText("메뉴 열기/닫기");
        ...
        m_jTitle.setFont(StartPOS.getgblFont().deriveFont( 1, 18)); // NOI18N
        ...
        m_jTitle.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                m_jTitleMouseClicked(evt);
            }
        });
        ...
        m_jPanelContainer.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    private void m_jTitleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_m_jTitleMouseClicked
        if (stacktop > 0) {
            String gotask = m_taskstack[--stacktop]; // Current task
            m_taskstack[stacktop] = "";
            if (stacktop > 0) {
                gotask = m_taskstack[--stacktop]; // Current task
                m_taskstack[stacktop] = "";
                m_appview.getAppUserView().showTask(gotask);
            }
        }
    }//GEN-LAST:event_m_jTitleMouseClicked
