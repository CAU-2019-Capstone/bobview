...
/**
 * Creation and Editing of stored settings unicentaopos.properties
 *
 * @author JG uniCenta
 * @author adrianromero
 */
public class AppConfig implements AppProperties {
    ...
    private File getDefaultConfig() {
        return new File(new File(System.getProperty("user.dir") + ("/database")), AppLocal.APP_ID + ".properties");     //can change DB config Directory
    }
    ...
    private void loadDefault() {
        ...
        m_propsconfig.setProperty("db.URL", "jdbc:derby:" + new File(new File(System.getProperty("user.dir") + ("/database")), AppLocal.APP_ID + "-database").getAbsolutePath() + ";create=true");      // can change default DB Directory
        m_propsconfig.setProperty("db.user", "");
        m_propsconfig.setProperty("db.password", "");

        // Add sms User ID, Password.(2015/2/11) by Yohan
        m_propsconfig.setProperty("sms.user", "");
        m_propsconfig.setProperty("sms.code", "");
        m_propsconfig.setProperty("sms.sender", "");
...
//        m_propsconfig.setProperty("db.URL", "jdbc:hsqldb:file:" + new File(new File(System.getProperty("user.dir") + ("/database")), AppLocal.APP_ID + "-db").getAbsolutePath() + ";shutdown=true");
...
//        m_propsconfig.setProperty("db.password", "password");        
        ...
        m_propsconfig.setProperty("swing.defaultlaf", System.getProperty("swing.defaultlaf", "org.pushingpixels.substance.api.skin.CremeCoffeeSkin"));
//        m_propsconfig.setProperty("swing.defaultlaf", System.getProperty("swing.defaultlaf", "javax.swing.plaf.synth.SynthLookAndFeel"));
        ...
        m_propsconfig.setProperty("machine.screenmode", "창 모드"); // fullscreen / window
        m_propsconfig.setProperty("machine.ticketsbag", "표준모드");
