...
public class PeopleView extends JPanel implements EditorRecord {
    private static final long serialVersionUID = 1917815953692244249L;
    ...
    private void initComponents() {
        ...
        m_jVisible.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jImage.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jRole.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jcard.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
