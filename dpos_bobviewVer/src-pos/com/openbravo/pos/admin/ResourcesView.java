...
public final class ResourcesView extends JPanel implements EditorRecord {
    private static final long serialVersionUID = 4372340469914281390L;
    ...
    private void initComponents() {
        ...
        m_jText.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jType.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
