...
// JG 3 Oct 2013 - Customer Transaction List
    ...
    class TransactionTableModel extends AbstractTableModel {
        private static final long serialVersionUID = -5915929705909502025L;
    ...
    private void initComponents() {
        ...
        m_jCategory.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        m_jVisible.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        txtMaxdebt.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        txtCurdebt.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        txtCurdate.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        jPanel1.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        jLabel10.setText("형식(010-xxxx-xxxx)");
        ...
        jTable1.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        m_jImage.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        m_jNotes.setFont(StartPOS.getgblFont().deriveFont(0, 12));
