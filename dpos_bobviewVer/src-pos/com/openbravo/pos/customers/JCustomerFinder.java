...
public class JCustomerFinder extends javax.swing.JDialog implements EditorCreator {
    private static final long serialVersionUID = -1811260253735231040L;
...
// Added JG 20 Sept 12
    ...
    private static class MyListData extends javax.swing.AbstractListModel {
        private static final long serialVersionUID = 4557382259986935382L;
    ...
    private void initComponents() {
        ...
        jLblTaxID.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jtxtTaxID.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        jLblSearchKey.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jtxtSearchKey.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        jLblPostal.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLblPostal.setText("우편번호");
        ...
        m_jtxtPostal.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        jLblName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jtxtName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        jLblPhone.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("pos_messages"); // NOI18N
        jLblPhone.setText(bundle.getString("label.companytelephone")); // NOI18N

        jLblEmail.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLblEmail.setText(bundle.getString("label.companyemail")); // NOI18N

        m_jtxtPhone.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        m_jtxtName2.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jListCustomers.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jButton1.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jButton3.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jcmdCancel.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
