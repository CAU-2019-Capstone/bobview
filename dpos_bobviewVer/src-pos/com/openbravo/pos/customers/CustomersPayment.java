...
public class CustomersPayment extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    private static final long serialVersionUID = 1830105871829515621L;
...
// JG 6 May use multicatch
    ...
    private void initComponents() {
        ...
        btnCustomer.setToolTipText("고객 계정");
        ...
        btnPay.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        txtCard.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        txtCurdebt.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        txtCurdate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        txtName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        txtName.setFocusable(false);
        txtName.setRequestFocusEnabled(false);

        txtMaxdebt.setEditable(false);
        txtMaxdebt.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        txtMaxdebt.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtMaxdebt.setFocusable(false);
        txtMaxdebt.setRequestFocusEnabled(false);

        txtNotes.setEnabled(false);
        txtNotes.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        txtTaxId.setEditable(false);
        txtTaxId.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
