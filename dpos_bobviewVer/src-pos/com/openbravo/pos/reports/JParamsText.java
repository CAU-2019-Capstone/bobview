...
public final class JParamsText extends javax.swing.JPanel implements ReportEditorCreator {
    private static final long serialVersionUID = 1303505190460805154L;
    ...
    private void initComponents() {
        ...
        lblField.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        lblField.setText("***");
        add(lblField);
        lblField.setBounds(20, 10, 120, 25);

        txtField.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(txtField);
