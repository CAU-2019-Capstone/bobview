...
public class JPanelCSVCleardb extends JPanel implements JPanelView {
    private static final long serialVersionUID = 1811665939180202383L;
    ...
    public JPanelCSVCleardb(AppProperties props) {
        ...
        jMessageBox.setText("CSV 작업 기록을 초기화 합니다. \n\n "
                + "새로운 CSV 가져오기 작업 전에 꼭 수행해 주세요. "
                + "삭제하시려면 하단의 체크박스를 선택하고 삭제하세요. \n");
