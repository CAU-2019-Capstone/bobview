 ...
 * @author JG uniCenta
 */
public class JPanelCSVSmallKoFood extends JPanel implements JPanelView {    
    private static final long serialVersionUID = 4127229583506417246L;
     ...
     * @param oApp
     */
    public JPanelCSVSmallKoFood(AppView oApp) {
     ...
     * @param props
     */
    public JPanelCSVSmallKoFood(AppProperties props) {  
        ...
        jMessageBox.setText("데이터베이스 생성 이후 다른 상품이 없을 때 사용할 수 있습니다.\n"
                ...
                + "김밥류, 분식류, 식사류, 부가메뉴 4가지의 분류를 추가합니다. \n\n"
                + "각 상품은 서비스 상품-부가세 대상-원격프린터 출력을 옵션으로 설정 합니다. \n"
                + "작업이후 기본분류는 재고>상품분류에서 삭제하셔도 됩니다.\n\n"
                + "환경설정>일반>계산모드에서 테이블후불모드로 변경하세요.");
    ...
    public String getTitle() {
        return AppLocal.getIntString("Menu.SmallKoFood");
    }
 ...
 // connect to the database
    ...
    private void jButtonCleardbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCleardbActionPerformed
        ...
        try {
            BatchSentence bsentence = new BatchSentenceResource(session, "/com/openbravo/pos/scripts/SmallKoFood.sql");
