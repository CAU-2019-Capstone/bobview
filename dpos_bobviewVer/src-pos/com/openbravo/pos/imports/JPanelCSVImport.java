...
public class JPanelCSVImport extends JPanel implements JPanelView {
    private static final long serialVersionUID = -1207537539295055200L;
    ...
    private static String category_disable_text = "[ 기본분류 사용 ]";
    ...
    private void GetheadersFromFile(String CSVFileName) throws IOException {
        ...
        if (f.exists()) {
            products = new CsvReader(new FileInputStream(CSVFileName),  Charset.forName("UTF-8"));
...
// create a new csv entry and save it using DataLogicSystem
    ...
    private void initComponents() {
        ...
        jTextInvalid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextInvalidActionPerformed(evt);
            }
        });
...
// check if a file was selected        
    ...
    private void jTextInvalidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextInvalidActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextInvalidActionPerformed
