...
public class JPanelConfigSystem extends javax.swing.JPanel implements PanelConfig {
    private static final long serialVersionUID = 5508292624259986399L;
...
//lets test for our settings       
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), bundle.getString("label.autologoffpanel"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, StartPOS.getgblFont().deriveFont( 1, 12), new java.awt.Color(102, 102, 102))); // NOI18N
        jPanel2.setLayout(null);

        jchkAutoLogoff.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jchkAutoLogoffToTables.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTextAutoLogoffTime.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabelInactiveTime.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        jLabelTimedMessage.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), bundle.getString("label.tabledisplayoptions"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, StartPOS.getgblFont().deriveFont( 1, 12), new java.awt.Color(102, 102, 102))); // NOI18N
        jPanel3.setLayout(null);

        jchkShowCustomerDetails.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jchkShowWaiterDetails.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabelCustomerTextColour.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jCustomerColour.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jLabelServerTextColour.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jWaiterColour.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jLabelTableNameTextColour.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTableNameColour.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jCloseCashbtn.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jCheckPrice00.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jchkTextOverlay.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTaxIncluded.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jMoveAMountBoxToTop.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jMoveAMountBoxToTop.setBounds(410, 20, 180, 30);
