...
import com.openbravo.pos.payment.ConfigPaymentPanelSerial;
...
public class JPanelConfigPayment extends javax.swing.JPanel implements PanelConfig {
    private static final long serialVersionUID = -7628185020456304833L;
...
//    private Map<String, PaymentConfiguration> paymentsName = new HashMap<String, PaymentConfiguration>();
    ...
    public JPanelConfigPayment() {
        ...
        initPayments("KCP(KR)", new ConfigPaymentPanelSerial());
        initPayments("NICE(KR)", new ConfigPaymentPanelSerial());
        initPayments("PayPoint / SecPay(UK)", new ConfigPaymentPanelGeneric()); 
        initPayments("AuthorizeNet(US, CA, UK, AU, EU)", new ConfigPaymentPanelGeneric());
        initPayments("BluePay AUTH.NET EMU(US, CA)", new ConfigPaymentPanelBluePayAUTHNETEMU()); 
        initPayments("BluePay 2.0 POST(US, CA)", new ConfigPaymentPanelBluePay20POST()); 
        initPayments("Planetauthorize(US, UK)", new ConfigPaymentPanelGeneric()); 
        initPayments("First Data / LinkPoint / YourPay", new ConfigPaymentPanelLinkPoint()); 
        initPayments("PaymentsGateway.net(US, CA)", new ConfigPaymentPanelGeneric());
        initPayments("La Caixa (Spain)", new ConfigPaymentPanelCaixa());

        // Lector de tarjetas.
        jcboCardReader.addItem("Not defined");
        jcboCardReader.addItem("VANTerminal");
    ...
    private void initComponents() {
        ...
        jcboPaymentGateway.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jchkPaymentTest.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabel11.setFont(StartPOS.getgblFont().deriveFont( 0, 10)); // NOI18N
        ...
        jcboCardReader.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
