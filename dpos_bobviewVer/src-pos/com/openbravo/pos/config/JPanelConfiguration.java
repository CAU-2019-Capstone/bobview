...
public class JPanelConfiguration extends JPanel implements JPanelView {
    private static final long serialVersionUID = 1226066866265130705L;
...
// JG 24 Oct 13 - Add Peripheral tab
    ...
    private void initComponents() {
        ...
        jPanelDatabase.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTabbedPane1.addTab("데이터베이스 설정", jPanelDatabase);

        jPanelGeneral.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTabbedPane1.addTab("일반", jPanelGeneral);

        jPanelLocale.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTabbedPane1.addTab("언어 및 지역", jPanelLocale);

        jPanelPayment.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTabbedPane1.addTab("지불 방법", jPanelPayment);

        jPanelPeripheral.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTabbedPane1.addTab("주변장치", jPanelPeripheral);

        jPanelSystem.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTabbedPane1.addTab("시스템 옵션", jPanelSystem);

        jPanelTicketSetup.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTabbedPane1.addTab("영수증 설정", jPanelTicketSetup);

        jbtnRestore.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jbtnSave.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
