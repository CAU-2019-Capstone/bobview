...
public class JPanelConfigERP extends javax.swing.JPanel implements PanelConfig {
    private static final long serialVersionUID = -8943553711431012149L;
    ...
    private void initComponents() {
        ...
        jtxtId.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jtxtName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        jtxtPassword.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jlabelUrl.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jlabelUrl.setText(AppLocal.getIntString("label.erpurl")); // NOI18N

        jLabelId.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabelName.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabelName.setText(AppLocal.getIntString("label.erpuser")); // NOI18N

        jLabelProperties.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
