...
public class JPanelTicketSetup extends javax.swing.JPanel implements PanelConfig {
    private static final long serialVersionUID = -8565620441970553855L;
...
// build the example receipt using the loaded details        
    ...
    private void initComponents() {
        ...
        jReceiptSize.setFont(StartPOS.getgblFont().deriveFont( 0, 18)); // NOI18N
        ...
        jTextReceiptPrefix.setFont(StartPOS.getgblFont().deriveFont( 0, 18)); // NOI18N
        ...
        jTicketExample.setFont(StartPOS.getgblFont().deriveFont( 0, 18)); // NOI18N
        ...
        jPickupSize.setFont(StartPOS.getgblFont().deriveFont( 0, 18)); // NOI18N
        ...
        m_jReceiptPrintOff.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), bundle.getString("label.SChargepanel"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, StartPOS.getgblFont().deriveFont( 1, 12), new java.awt.Color(102, 102, 102))); // NOI18N
        jPanel5.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jPanel5.setLayout(null);

        jchkSCOnOff.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jchkSCRestaurant.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTextSCRate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabelSCRate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabelSCRatePerCent.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jLabel4.setFont(StartPOS.getgblFont().deriveFont( 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(102, 102, 102));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("팁을 계산에 포함시킬때 사용합니다.");
        jPanel5.add(jLabel4);
