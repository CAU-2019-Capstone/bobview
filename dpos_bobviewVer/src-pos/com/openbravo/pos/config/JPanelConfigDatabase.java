...
public class JPanelConfigDatabase extends javax.swing.JPanel implements PanelConfig {
    private static final long serialVersionUID = 5174687828746201625L;
...
//  JG 31 Aug 13 - Added DB Defaults
    ...
    private void initComponents() {
        ...
        jLabel6.setText("데이터베이스");

        jcboDBDriver.setFont(StartPOS.getgblFont().deriveFont(0, 14));
        ...
        jtxtDbDriverLib.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        jLabel1.setFont(StartPOS.getgblFont().deriveFont(0, 10));
        jLabel1.setText(AppLocal.getIntString("Label.DbDriver")); // NOI18N

        jtxtDbDriver.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        jtxtDbURL.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        jtxtDbUser.setFont(StartPOS.getgblFont().deriveFont(0, 12));

        jLabel4.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        jLabel4.setText(AppLocal.getIntString("Label.DbPassword")); // NOI18N

        jtxtDbPassword.setFont(StartPOS.getgblFont().deriveFont(0, 12));

        jButtonTest.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        jLabel5.setFont(StartPOS.getgblFont().deriveFont(0, 13));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/Dongwun_logo_vert_100.png"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(20, 20, 20)
                        .addComponent(jButtonTest, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel5.getAccessibleContext().setAccessibleName("<html><div><b>dPOS의 기본 데이터베이스는 Apache Derby Embedded 입니다.<br>해당 DB는 싱글유저, 단독 실행, 적은 볼륨을 위해 적용되었고, 프로그램 설치와 함께 적용됩니다.</b><br><br> <div>만약 다른 DB를 사용하실 때에는 목록에 있는 여러 DB 중 하나를 선택하실 수 있습니다.<br></div></div> <div>다른 DB를 선택할 경우 dPOS에 접속하기 위해 일련의 설정 과정을 먼저 거쳐야 합니다.<br><br>문의 사항은 네이버 개발자 센터 dPOS 포럼이나 동운시스템 고객센터를 이용해 주세요.</div>");
...
//  JG 31 Aug 13 - Added DB Defaults
        ...
        if ("Apache Derby Embedded".equals(jcboDBDriver.getSelectedItem())) {
            ...
            jtxtDbURL.setText("jdbc:derby:" + new File(new File(System.getProperty("user.dir") + ("/database")), AppLocal.APP_ID + "-database").getAbsolutePath() + ";create=true");
            jtxtDbUser.setText("");
            ...
            jtxtDbURL.setText("jdbc:derby://localhost:1527/dpos");
            ...
            jtxtDbURL.setText("jdbc:hsqldb:file:" + new File(new File(System.getProperty("user.dir") + ("/database")), AppLocal.APP_ID + "-db").getAbsolutePath() + ";shutdown=true");
            ...
            jtxtDbURL.setText("jdbc:oracle:thin://localhost:1521/dpos");
...
//  JG 3 Oct 13 - Test DB Connection
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String URL = "http://www.dongwun.com/neo/bbs/write.php?bo_table=qna";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try {
            String URL = "http://www.dongwun.com/dpos/";
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(URL));
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
