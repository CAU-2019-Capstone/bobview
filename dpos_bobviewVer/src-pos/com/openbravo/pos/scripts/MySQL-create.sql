...
-- Copyright (c) 2009-2017 Dongwun & uniCenta & previous Openbravo POS works
-- v1.00 confirm DB connect string to : dbname?useUnicode=true&characterEncoding=UTF-8
...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', '관리자 역할', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', '점장 역할', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', '직원 역할', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', '관리자', NULL, '0', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', '점장', NULL, '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', '직원', NULL, '2', TRUE, NULL);
...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('000', '기본 분류');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', '면세');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', '부가세');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', '면세', '000', NULL, NULL, 0, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', '부가세', '001', NULL, NULL, 0.10, FALSE, NULL);
...
INSERT INTO LOCATIONS(ID, NAME,ADDRESS) VALUES('0', '점포', NULL);
...
INSERT INTO FLOORS(ID, NAME) VALUES ('0', '매장');
...
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('1', '테이블 1', 70, 70, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('2', '테이블 2', 210, 70, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('3', '테이블 3', 350, 70, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('4', '테이블 4', 70, 210, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('5', '테이블 5', 210, 210, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('6', '테이블 6', 350, 210, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('7', '테이블 7', 70, 350, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('8', '테이블 8', 210, 350, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('9', '테이블 9', 350, 350, '0');
