...
public class ThirdPartiesView extends javax.swing.JPanel implements EditorRecord {
    private static final long serialVersionUID = -1400545011008673050L;
    ...
    private void initComponents() {
        ...
        m_jCIF.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jCIF);
        ...
        m_jContactComm.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jContactComm);
        ...
        m_jContactFact.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jContactFact);
        m_jContactFact.setBounds(380, 190, 160, 25);

        jLabel6.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabel6.setText("지불 방식");
        add(jLabel6);
        jLabel6.setBounds(20, 340, 120, 25);

        m_jPayRule.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jPayRule);
        ...
        m_jFaxNumber.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jFaxNumber);
        ...
        m_jPhoneNumber.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jPhoneNumber);
        m_jPhoneNumber.setBounds(110, 220, 160, 25);

        jLabel9.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabel9.setText("휴대전화");
        add(jLabel9);
        jLabel9.setBounds(290, 220, 90, 25);

        m_jMobileNumber.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jMobileNumber);
        ...
        m_jEMail.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jEMail);
        m_jEMail.setBounds(380, 250, 160, 25);

        jLabel11.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jLabel11.setText("홈페이지");
        add(jLabel11);
        jLabel11.setBounds(20, 280, 90, 25);

        m_jWebPage.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        add(m_jWebPage);
        ...
        m_jNotes.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jScrollPane1.setViewportView(m_jNotes);

        add(jScrollPane1);
        jScrollPane1.setBounds(110, 410, 270, 70);

        jScrollPane2.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        m_jAddress.setFont(StartPOS.getgblFont().deriveFont( 0, 14));
        jScrollPane2.setViewportView(m_jAddress);

        add(jScrollPane2);
        jScrollPane2.setBounds(110, 80, 270, 70);

        jLabel14.setFont(StartPOS.getgblFont().deriveFont( 1, 12)); // NOI18N
        jLabel14.setText("연락처");
        jLabel14.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        add(jLabel14);
        jLabel14.setBounds(20, 160, 520, 18);

        jLabel15.setFont(StartPOS.getgblFont().deriveFont( 1, 12)); // NOI18N
        jLabel15.setText("지불");
        jLabel15.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        add(jLabel15);
        jLabel15.setBounds(20, 310, 520, 18);

        jLabel16.setFont(StartPOS.getgblFont().deriveFont( 1, 12)); // NOI18N
        jLabel16.setText("비고");
        jLabel16.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        add(jLabel16);
        jLabel16.setBounds(20, 380, 520, 18);
