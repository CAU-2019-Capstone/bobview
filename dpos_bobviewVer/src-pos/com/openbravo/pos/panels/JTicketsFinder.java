...
public class JTicketsFinder extends javax.swing.JDialog implements EditorCreator {
    private static final long serialVersionUID = -6180518953326246941L;
...
//        jcboMoney.setModel(new ListQBFModelNumber());
    ...
    private static class MyListData extends javax.swing.AbstractListModel {
        private static final long serialVersionUID = -5371487627014200920L;
    ...
    private void initComponents() {
        ...
        jtxtMoney.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        jcboUser.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jcboMoney.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N

        jtxtTicketID.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N

        labelCustomer.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jTxtStartDate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jTxtStartDate.setPreferredSize(new java.awt.Dimension(200, 25));

        jTxtEndDate.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        btnDateStart.setToolTipText("달력 열기");
        ...
        btnDateEnd.setToolTipText("달력 열기");
        ...
        jtxtCustomer.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jComboBoxTicket.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        jListTickets.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        jcmdOK.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
