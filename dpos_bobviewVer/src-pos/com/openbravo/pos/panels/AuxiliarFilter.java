...
public class AuxiliarFilter extends javax.swing.JPanel implements ReportEditorCreator {
    private static final long serialVersionUID = 2549379730951641515L;
    ...
    private void initComponents() {
        ...
        m_jReference1.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        Enter1.setToolTipText("상품 ID 입력");
        ...
        m_jBarcode1.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jSearch.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
