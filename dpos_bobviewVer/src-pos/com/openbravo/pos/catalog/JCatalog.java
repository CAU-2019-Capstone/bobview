...
public class JCatalog extends JPanel implements ListSelectionListener, CatalogSelector {
    private static final long serialVersionUID = 3458302106161124304L;
...
// ADDED JDL 09.04.13 TEXT TIP FUNCTION   getProductLabel(prod)))      product.getDisplay()
    ...
    private class CategoriesListModel extends AbstractListModel {
        private static final long serialVersionUID = -3386310003253652957L;
    ...
    private class SmallCategoryRenderer extends DefaultListCellRenderer {
        private static final long serialVersionUID = -358780359950048449L;
    ...
    private void initComponents() {
        ...
        m_jRootCategories.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N
        ...
        m_jscrollcat.setFont(StartPOS.getgblFont().deriveFont( 0, 11)); // NOI18N

        m_jListCategories.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
