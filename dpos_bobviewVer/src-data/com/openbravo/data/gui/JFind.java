...
public class JFind extends JDialog {
    private static final long serialVersionUID = -4533440472110713850L;
    ...
    private void initComponents() {
        ...
        m_jFind.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        jPanel1.add(m_jFind);
        ...
        m_jWhere.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        ...
        m_jMatch.setFont(StartPOS.getgblFont().deriveFont( 0, 14)); // NOI18N
        m_jMatch.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jMatchActionPerformed(evt);
            }
        });
        jPanel1.add(m_jMatch);
        m_jMatch.setBounds(110, 80, 230, 25);

        m_jMatchCase.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
    ...
    private void m_jMatchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jMatchActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_m_jMatchActionPerformed
