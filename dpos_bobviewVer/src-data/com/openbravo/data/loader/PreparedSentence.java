...
//        }
    ...
    public DataResultSet openExec(Object params) throws BasicException {
        ...
        try {
            ...
            /*FOR DEBUG StackTraceElement[] stackTrace = Thread.currentThread().getStackTrace(); 
            String qstr = "";
            for(int i=2; i<stackTrace.length; i++) {
                qstr += stackTrace[i] + "<";
                if (stackTrace[i].toString().contains("JRootApp.java")) break;
            }
            qstr = qstr.replace("com.openbravo.", "");*/
            //m_sentence = m_sentence + "/*"+qstr+"*/";   
