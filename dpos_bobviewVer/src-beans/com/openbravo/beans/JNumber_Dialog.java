 ...
 * @author  adrian
 */
public class JNumber_Dialog extends javax.swing.JDialog {
    private static final long serialVersionUID = 4172624813809076707L;
    
    private static LocaleResources m_resources;
    
    private Double m_value;
    
    /** Creates new form JNumber_Dialog
     * @param parent
     * @param modal */
    public JNumber_Dialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        init();
    }
     ...
     * @param parent
     * @param modal */
    public JNumber_Dialog(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        init();
    }
    ...
    public static Double showEditNumber(Component parent, String title, String message, Icon icon) {
        ...
        JNumber_Dialog myMsg;
        if (window instanceof Frame) { 
            myMsg = new JNumber_Dialog((Frame) window, true);
        } else {
            myMsg = new JNumber_Dialog((Dialog) window, true);
        }
    ...
    private void initComponents() {
        ...
        jcmdOK.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        jcmdCancel.setFont(StartPOS.getgblFont().deriveFont(0, 12));
        ...
        m_jnumber.setFont(StartPOS.getgblFont().deriveFont(0, 12));
