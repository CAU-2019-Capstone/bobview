...
public class JCalendarPanel extends javax.swing.JPanel {
    private static final long serialVersionUID = 7246456501606366016L;
...
//        oCalRender.setTime(m_CalendarHelper.getTime());
    ...
    private static class JButtonDate extends JButton {
        private static final long serialVersionUID = -6985787288179171206L;
    ...
    private void initComponents() {
        ...
        m_jDates.setFont(StartPOS.getgblFont().deriveFont( 0, 12)); // NOI18N
        ...
        m_jLblMonth.setFont(StartPOS.getgblFont().deriveFont( 1, 14));
