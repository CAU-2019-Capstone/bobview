...
export default {
  ...
  methods: {
    ...
    deleteItem (item) {
      ...
      this.axios
        .delete('https://13.124.90.6:8080/api/menuinfo/'+this.editedItem['menu_id']+'/')
    ...
    save () {
      ...
      if (this.editedIndex > -1) {
        ...
        setTimeout(function(){
          currentObj.axios
            .put('https://13.124.90.6:8080/api/menuinfo/'+currentObj.currentMenuInfo[currentObj.editedIndex]['menu_id']+'/', {
        ...
        setTimeout(function(){
          currentObj.axios.post('https://13.124.90.6:8080/api/menuinfo/', {
