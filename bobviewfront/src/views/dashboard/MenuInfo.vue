        ...
        >
          ...
          <v-toolbar flat color="white">
              ...
              <template v-slot:activator="{ on }">
                  <v-btn color="blue lighten-3" dark class="mb-2 mx-2" @click="commitRestaurant">Preview</v-btn>
                  <v-btn color="blue lighten-2" dark class="mb-2" v-on="on">New Item</v-btn>
              </template>
              <v-card>
                  <v-card-title>
...
export default {
  ...
  methods: {
    ...
    deleteItem (item) {
      ...
      this.axios
        .delete('https://www.bobview.org:8080/api/menuinfo/'+this.editedItem['menu_id']+'/')
    ...
    save () {
      ...
      if (this.editedIndex > -1) {
        ...
        setTimeout(function(){
          currentObj.axios
            .put('https://www.bobview.org:8080/api/menuinfo/'+currentObj.currentMenuInfo[currentObj.editedIndex]['menu_id']+'/', {
        ...
        setTimeout(function(){
          currentObj.axios.post('https://www.bobview.org:8080/api/menuinfo/', {
