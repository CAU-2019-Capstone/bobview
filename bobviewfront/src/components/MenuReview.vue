...
export default {
    ...
    methods: {
        initiate() {
            ...
            let currentObj = this
            this.axios
                .get('http://13.124.90.6:8080/api/menurating/'+currentObj.menu_rating_id+'/')
                .then((result)=>{
            ...
            this.axios
                .get('http://13.124.90.6:8080/api/commentlist/0/?menu_rating_id='+this.menu_rating_id)
                .then((result)=>{
                    console.log(result.data)
            ...
            setTimeout(function(){
                ...
                currentObj.axios
                    .get('http://13.124.90.6:8080/api/userinfo/'+currentObj.menu_rating['user'].split('/')[5]+'/')
                    .then((result)=>{   
                        console.log(result.data)
