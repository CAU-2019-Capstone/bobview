    ...
    methods : {
        save() {
            ...
            if(currentObj.restaurantRating['rating']>0){
                for(let [index] in  currentObj.ordermenus){
                    ...
                    if(this.ordermenus[index]['menu_rating']['menu_rating_id'] != undefined){
                        currentObj.axios.put('http://13.124.90.6:8000/api/menurating/'+currentObj.ordermenus[index]['menu_rating']['menu_rating_id']+'/', {
                        ...
                        currentObj.axios.post('http://13.124.90.6:8000/api/menurating/', {
            ...
            if(currentObj.restaurantRating['rest_rating_id'] == undefined){
                currentObj.axios.post('http://13.124.90.6:8000/api/restrating/', {
                ...
                currentObj.axios.put('http://13.124.90.6:8000/api/restrating/'+currentObj.restaurantRating['rest_rating_id']+'/', {
                    rating:currentObj.restaurantRating['rating'],
                    desc:currentObj.restaurantRating['desc'],
                })
                .then((result) => {
        ...
        initMenus(){
            ...
            let currentObj = this
            let restaurant=''
            currentObj.axios.get('http://13.124.90.6:8000/api/userorder/'+this.order_id+'/')
                .then((result) => {
                    console.log(result.data)
            ...
            currentObj.axios.get('http://13.124.90.6:8000/api/ordercontents/1/?order_id='+this.order_id)
                .then((result) => {
                    console.log(result.data)
            ...
            setTimeout(() => {
                ...
                currentObj.axios
                    .get('http://13.124.90.6:8000/api/restrating/1/?restaurant_name='+restaurant.split('/')[5]+'&username='+username)
                    .then((result) => {
                ...
                for(let [index] in currentObj.ordermenus){
                    ...
                    currentObj.axios
                    .get('http://13.124.90.6:8000/api/menurating/1/?username='+username+'&menu_id='+menu_id)
                    .then((result) => {
